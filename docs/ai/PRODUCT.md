...
The unauthenticated surface is a game-first detailed pixel-storybook prairie rather than a decorative 3D login scene. Pixel Xiaohua runs, jumps, crouches, stumbles, and celebrates records while the login form stays available without dominating play. The playable area is a centered 16:9 frame on desktop/landscape (capped at 1440×810) and a centered 3:4 frame in portrait, so character, ground, and obstacle proportions remain stable across devices; a matching sky-to-grass gradient softens the surrounding area. Portrait places a collapsible card in the sky area; landscape keeps only a login trigger until requested. Touch uses transparent left/right halves for hold-to-crouch and tap-to-jump, mirrored by Down/S and Space/Up on keyboards. Difficulty follows speed-gated Chrome-runner principles: ground obstacles lead, low birds join after 18 seconds, fair two-action sequences begin after 40 seconds, continuous acceleration tightens reaction time, randomized width-aware gaps prevent a metronomic rhythm, and duplicate history avoids repetitive runs. Login, leaderboard, and name overlays pause and lock runner input. The public leaderboard retains only the global Top 3 and lets qualifying players leave a short name.
